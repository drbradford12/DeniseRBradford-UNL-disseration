...
In the book "Data Visualization: a successful design process," Andy Kirk defined data visualization as "the representation and presentation of data that exploits our visual perception abilities to amplify cognition" [@kirk2012]. 
This suggests that data visualization involves the misuse of human visual perception in addition to the presentation of data.
Assigning meaning to visualization is not a statistical or computational step but a cognitive one.
...
It activates photoreceptor cells in the retina, initiating a cascade of neural signals transmitted to the brain's visual cortex via the optical nerve [@hubel2004].
...
Perceptual grouping is a fundamental process in visual perception involving the organization of individual visual elements into coherent perceptual units based on their inherent properties and spatial relationships. 
It helps us make sense of the complex visual world by grouping elements that belong to the same object or structure and separating elements that belong to different entities. 
Gestalt psychologists have extensively studied the concept of perceptual grouping, proposing principles such as proximity, similarity, closure, and continuity as grouping's underlying mechanisms. 
...
Figure xxx shows that the perceptual grouping that is illustrated by [@palmer2002]....  

```{r perceptualgrouping, echo=FALSE, out.width = "55%", fig.cap='Perceptual Grouping illustrated by Palmer in 2002',fig.show='asis',fig.align='center'}
...
At its most basic, the entire form is perceived (or emerges to our visual pathways) as opposed to its component parts, seen in the following figure provided by [@gestaltimage].
...
Starting with Wertheimer's experiments on the perception of motion examined the phenomenon of apparent motion, which refers to the perception of motion when successive stationary stimuli are presented. 
...
His experiments revealed that the perception of motion results from the interaction between sensory input and perceptual organization processes.

The research of Wertheimer emphasized the significance of perceptual grouping principles, such as proximity and similarity, in the perception of motion. 
...
Preattentive processing in vision refers to the rapid and automatic extraction of basic visual features from the environment before conscious attention is directed to particular objects or regions. 
The effortless and parallel initiation of visual processing occurs across the visual field.
Preattentive processing entails the extraction of low-level visual characteristics such as color, shape, movement, and orientation. 
These features are processed in a highly efficient and automatic manner, allowing the brain to detect and classify visual information rapidly and unconsciously.




The capacity of the visual system to automatically integrate and extract relevant information from visual stimuli, even in the absence of focused attention, is referred to as the ability to perceive unity, uniformity, and global patterns without conscious attention. 
This preattentive processing enables rapid perception of the visual environment's global patterns and structures.

[@goldberg1994] conducted research focusing specifically on the perception of unity and uniformity prior to attention. 
They provided evidence for the preattentive extraction of global features such as shape, orientation, and motion through their experiments. 
The findings suggested that the visual system integrates local elements into coherent global patterns automatically, allowing for the perception of unity and uniformity without conscious attention.
