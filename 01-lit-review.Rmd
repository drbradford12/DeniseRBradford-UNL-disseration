...
```{r goms_model, eval=FALSE, echo=FALSE, out.width = "45%",fig.cap='GOMS Model created by Card, Moran and Newell', fig.show='hold', fig.align='center'}
...
Huang et al. build on the understanding that Richard Atkinson and Richard Shiffrin,  wrote the information processing model of memory, @atkinson1968.

```{r atkinson_model, eval=FALSE, echo=FALSE, out.width = "45%",fig.cap='Information Processing Model created by Atkinson and Shiffin, 1968', fig.show='hold', fig.align='center'}
