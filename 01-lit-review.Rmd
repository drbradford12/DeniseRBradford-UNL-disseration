...
knitr::include_graphics("figure/VizModelDiagram")
```
...
```{r graphics, echo=FALSE, fig.width=3, fig.height=3,fig.cap='Grammar of Graphics Diagram of Wickham and Wilkinson's work',fig.show='hold',fig.align='center'}
knitr::include_graphics("figure/gglayers")
knitr::include_graphics("figure/graphic-flowchart")
```
