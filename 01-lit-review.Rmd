...
As demonstrated by figure xxx, [@alberts2019] provides F-pattern reading flow support. 
...
Figure xxx,[@alberts2019], has less content density and supports a Z-pattern reading flow in which users begin in the upper-left corner and zigzag to the bottom.
