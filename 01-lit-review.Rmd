...
Heer and Bostock (@heer2010) examined how the complexity of interactive visualizations influences the cognitive load of users. 
...
Ko and Kwon (@ko2017) investigated the cognitive load of mobile interactive visualizations. 
...
Nguyen and Gajos (@nguyen2015) investigated the impact of interactive elements on cognitive load in visualizations. 
...
### Background Research on testing static graphics

<!-- Brief overview of user studies that compare different types of graphics, accuracy, etc. -->

Cleveland and McGill investigated the effect of various bar chart designs on the accuracy with which viewers perform simple perceptual tasks @Cleveland. 
...
"The cognitive style of PowerPoint: Pitching out corrupts within" examined the effect of static graphics, such as bar charts, line charts, and pie charts, on the comprehension and decision-making of viewers @Tufte. 
...
### Background Research on testing interactive graphics
...
In addition to their benefits for data exploration and analysis, interactive graphics have been found to be more engaging and enjoyable for users @bresciani2014. 
...
Tufte discovered that adding unnecessary visual cues to a graph decreases its effectiveness because viewers are more likely to focus on the embellishments rather than the data (@tufte1983).
