...
A dashboard is a visual display of the essential information needed to achieve one or more objectives, consolidated and arranged on a single screen so the information can be monitored at a glance [@few]. 
...
<!-- \begin{center} -->
<!-- \includegraphics[width=\textwidth]{figure/VizModelDiagram.png} -->
...
<!-- \begin{center} -->
<!-- \includegraphics[width=\textwidth]{figure/gglayers.png} -->
...
<!-- \begin{center} -->
<!-- \includegraphics[width=\textwidth]{figure/graphic-flowchart.png} -->
<!-- \captionof{figure}{Grammar of Graphics Diagram of Wickham and Wilkinson's work} -->
<!-- \end{center} -->
