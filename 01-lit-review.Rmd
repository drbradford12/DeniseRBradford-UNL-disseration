...
\db{The connection between EDA and dashboards is that EDA is the process of preparing and understanding the data, which is the first step for building a dashboard, as the data has to be cleaned, transformed, and analyzed to be used efficiently on the dashboard. 
...
\db{A schema is a mental model containing a breadth of information about a specific object or concept. 
...
In chapter 1, we will demonstrate the process of designing and redesigning a dashboard for public use, we outline and create a framework in which a dashboard generates data that were collected on rural areas.
In chapter 2, we will discuss parallel coordinate plots (PCPs) and the how they are interpreted.
In chapter 3, we will introduces new methods for interactive PCPs that faciliate greater user engagement with complex, multivariate data.
}
