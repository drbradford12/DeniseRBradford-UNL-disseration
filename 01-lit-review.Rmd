...
Perception and attention are crucial cognitive processes that allow usr to interpret and make sense of data visualizations. 
...
```{r visual, echo=FALSE, out.width = "45%", fig.cap='Visual Attentionn can repersented by the following',fig.show='hold',fig.align='center'}
