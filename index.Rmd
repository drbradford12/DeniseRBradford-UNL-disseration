...
There are seven major components that help build effective visualizations that build on one another: The following will show the building blocks of the type of layering.
