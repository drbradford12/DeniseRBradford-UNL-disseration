...
Some design constraints stem from limitations of the human perceptual system and are common to most potential consumers of the visualization: the sine illusion affects anyone with binocular depth perception, and color recommendations are built around the specific characteristics of the human retina (VanderPlas \& Hofmann, 2015).
...
\caption{Gestalt Principles with Examples [@gestaltimage]}\label{fig:gestalt}
\end{figure}
...
{\centering \includegraphics[width=0.45\linewidth]{figure/Baddeley_model} \includegraphics[width=0.45\linewidth]{figure/info_model} 

}

\caption{Working Memory Model created by Baddeley (left) and nformation Processing Model created by Atkinson and Shiffin (right)}\label{fig:baddeleymodel}
\end{figure}

Statistical graphics, such as charts and graphs, provide visually perceivable stimuli that can be temporarily stored in sensory memory.
Relevant graphic information must be attended to and transferred to STM for further analysis if it is to be effectively processed and remembered.
The correct encoding of significant statistical patterns or relationships into LTM can improve the retention and recall of the presented data.
...
This version of the thesis was generated on 2023-06-26 21:44:33. The repository is currently at this commit:
