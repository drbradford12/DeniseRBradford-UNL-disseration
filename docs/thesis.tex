...
\chapter{The Dashboard as a Unified Chart: Enhancing Data Visualization and Insights}\label{math-sci}}
...
\textbf{Interactivity and User Experience:}
...
\hypertarget{unified-chart-dashboard-design}{%
\section{Unified Chart Dashboard Design:}\label{unified-chart-dashboard-design}}

Here is how published theory relates graphic grammar to dashboard design:

\textbf{Data Layer:}
Data is the foundation of visualizations in the grammar of graphics.
...
\textbf{Aesthetics Layer:}
refer to the mapping of data variables to visual properties such as color, size, shape, and position.
...
\textbf{Geometries:}
determine how data points, such as bars, lines, points, or areas, are represented in the visualization.
...
\textbf{Composition and Layers:}
The grammar of graphics permits the combination of multiple layers of data and geometries to generate more complex visualizations.
...
\chapter{Ensemble Perecption and Bland Altman Plots}\label{ref-labels}}
...
Bland-Altman plots are commonly used in medical and health science research to assess agreement between two different measures or techniques (Bland \& Altman, 1986), whereas Ensemble Perception encoding is widely used in cognitive science to evaluate how observers extract summary statistics from complex sensory inputs (Alvarez, 2011).
...
Bland-Altman plots demonstrate strong capabilities in analyzing the degree of agreement and the level of variability or bias between two different measurement systems, providing a visual representation of measurement differences against their mean (Giavarina, 2015).
...
The process is critical in summarizing and interpreting complex sensory inputs by rapidly extracting their statistical properties, thereby facilitating efficient cognitive processing (Whitney \& Yamanashi Leib, 2018).
...
{\centering \includegraphics[width=0.45\linewidth]{figure/baplot} 

}

\caption{Example 1 Bland-Altman Plot without color and annotations}\label{fig:baplot}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=0.45\linewidth]{figure/baplot1} 

}

\caption{Example 2 Bland-Altman Plot with color and no annotations}\label{fig:baplot1}
\end{figure}
...
This version of the thesis was generated on 2023-07-29 15:59:40. The repository is currently at this commit:
...
Giavarina, D. (2015). Understanding bland altman analysis. \emph{Biochemia Medica}, \emph{25}(2), 141--151.
...
\leavevmode\vadjust pre{\hypertarget{ref-whitney2018}{}}%
