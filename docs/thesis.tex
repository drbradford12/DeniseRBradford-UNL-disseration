...
\hypertarget{pie-chart-or-doughnut-chart}{%
\subsection{Pie Chart or Doughnut Chart}\label{pie-chart-or-doughnut-chart}}

\hypertarget{treeshierarchical-maps}{%
\subsection{Trees/Hierarchical Maps}\label{treeshierarchical-maps}}
...
\hypertarget{parallel-coordinate-plot-visualization}{%
\section{Parallel Coordinate Plot Visualization}\label{parallel-coordinate-plot-visualization}}
...
\texttt{ggparallel} implements and combines different types of parallel coordinate plots for categorical data: hammock plots (\textbf{Schonlau?})(), parallel sets plots, common angle plots, and common angle plots with a hammock-like adjustment for line widths (Hofmann \& Vendettuoli, 2016)().

\hypertarget{why-gg-and-ggplot-are-important}{%
\subsection{\texorpdfstring{Why \texttt{gg} and \texttt{ggplot} are important?}{Why gg and ggplot are important?}}\label{why-gg-and-ggplot-are-important}}
...
A collaboration is defined when 2 or more entities work together to produce a desired and shared outcome.(\textbf{collab?})() Interdisciplinary research with collaboration is a pinnacle aspect of dashboards and statistical graphics to produce innovation and scientific knowledge.

The National Academies defines research collaboration as follows (\textbf{National?} Academics Ref)():
...
This version of the thesis was generated on 2022-10-10 09:27:38. The repository is currently at this commit:
...
\leavevmode\hypertarget{ref-ggparallel}{}%
